# (OLFFH4XAPI) Thank you from me to the haters
import os
import json
import aiohttp
import asyncio
...
TOKEN = os.getenv('8649981442:AAH_CUdLOoh6K4By5p9GXFfKXDA_u7fKXOM') # Prefer .env
if not TOKEN or TOKEN == "8649981442:AAH_CUdLOoh6K4By5p9GXFfKXDA_u7fKXOM": # Check if token is missing or placeholder
    # !!! Replace with your actual bot token if not using .env !!!
    TOKEN = "8649981442:AAH_CUdLOoh6K4By5p9GXFfKXDA_u7fKXOM" # FALLBACK - Highly recommended to use .env

# Optional: API Configuration
API_BASE_URL = os.getenv('JWT_API_URL', 'https://rs-jwt-token-six.vercel.app/token')
API_KEY = os.getenv('JWT_API_KEY', '')

# Optional: Bot Settings
MAX_FILE_SIZE = int(os.getenv('MAX_FILE_SIZE', 5 * 1024 * 1024))  # 5MB default
ADMIN_ID = int(os.getenv('ADMIN_ID', 6474022249)) # Default to 0 (disabled) if not set or invalid
# Check and warn if ADMIN_ID is 0 but commands are expected
if ADMIN_ID == 6474022249:
...
ADMIN_CONTACT_LINK = os.getenv('ADMIN_CONTACT_LINK', 'https://t.me/SILENT_CODEX') # Default admin contact link
